<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        $sql = "SELECT empId, password, username, role FROM Employee WHERE username = ?";        
        ...
        if ($stmt->num_rows > 0) {
            ...
            $stmt->bind_result($id, $hash, $empName, $empRole);          //The columns for employeeid, password, employee name and role are bound to the variables within the brackets
